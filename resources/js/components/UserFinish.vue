<template>
  <div
    class="sm:w-96 w-full pb-6 px-6 relative break-words min-h-screen flex items-center  md:h-full md:shadow-lg md:rounded-lg"
...
export default {
  ...
  mounted() {
    // убираем за собой
    localStorage.removeItem("check-first-screen");
    document.cookie = "url" + '=; Max-Age=-1'
  }
};
</script>
